    ...
    <section class="flex flex-col flex-1">
        ...
        <nav class="flex items-center text-gray-600 text-sm mb-4" aria-label="Breadcrumb">
            ...
            <a href="/detail-diskusi/{{ \Vinkla\Hashids\Facades\Hashids::encode($discussion->id) }}">
                <span class="text-gray-800 font-semibold hover:text-blue-500 transition-colors">Detail Diskusi</span>
            </a>

            <span class="mx-2 text-gray-400">/</span>

            <span class="text-gray-800 font-semibold">Edit Diskusi</span>
        </nav>
