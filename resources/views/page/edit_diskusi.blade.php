    ...
    <section class="flex flex-col flex-1">
        ...
        <nav class="flex items-center text-gray-600 text-sm mb-4" aria-label="Breadcrumb">
            ...
            <a href="/detail-diskusi/{{ \Vinkla\Hashids\Facades\Hashids::encode($discussion->id) }}">
                <span class="text-gray-700 font-semibold hover:text-blue-500 hover:underline transition-colors">Detail Diskusi</span>
            </a>

            <span class="mx-2 text-gray-700">/</span>

            <span class="text-gray-700 font-semibold">Edit Diskusi</span>
        </nav>
            ...
            @csrf
                ...
                <div class="flex flex-col mb-4">
                    ...
                    <input
                        ...
                        value="{{ old('judul', $discussion->judul) }}"
                        required
                        autocomplete="off"
                    />
                    @error('judul')
                    ...
                    <div class="relative">
                        ...
                        >
                            ...
                            @foreach($allCategories as $category)
                                <option value="{{ $category->kategori }}" {{ old('kategori', $discussion->category->kategori) == $category->kategori ? 'selected' : '' }}>{{ $category->kategori }}</option>
                            @endforeach
                        </select>
                ...
                <div class="">
                    ...
                    <input id="deskripsi" type="hidden" name="deskripsi" required value="{{ old('deskripsi', $discussion->deskripsi) }}">
